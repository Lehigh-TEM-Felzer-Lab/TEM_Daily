/* *************************************************************
TTEMDATD.CPP - object to read and write the structure of the
...
void Temdat45::getyrsum( const int& CYCLE,
                         double mon[366] )
{
...
void Temdat45::outdelm( ofstream& ofile,
                        const float& col,
                        const float& row,
                        const string& varname,
                        const int& icohort,
...
void Temdat45::poutdelm( ofstream& ofile,
                         const float& col,
                         const float& row,
                         const string& varname,
                         const int& icohort,
